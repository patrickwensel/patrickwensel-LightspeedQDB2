...
namespace QBD2.Migrations
{
    ...
    [Migration("20220524073521_AddNewObjects2")]
    partial class AddNewObjects2
    {
            ...
            modelBuilder.Entity("QBD2.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "82663a06-0018-4bc5-be83-395d58745f53",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "34eebf0e-5deb-4070-a9ae-c9be51daa52c",
                            Name = "Admin",
