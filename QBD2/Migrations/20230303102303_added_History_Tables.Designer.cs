...
namespace QBD2.Migrations
{
    ...
    [Migration("20230303102303_added_History_Tables")]
    partial class added_History_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QBD2.Entities.BuildStationInspection", b =>
                {
                    b.Property<int>("BuildStationInspectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildStationInspectionId"), 1L, 1);
                    ...
                    b.HasKey("BuildStationInspectionId");
                    ...
                    b.ToTable("BuildStationInspections");
                });

            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionFailure", b =>
                {
                    b.Property<int>("BuildStationInspectionFailureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildStationInspectionFailureId"), 1L, 1);
                    ...
                    b.HasKey("BuildStationInspectionFailureId");

                    b.HasIndex("BuildStationInspectionId");

                    b.HasIndex("FailureTypeId");

                    b.ToTable("BuildStationInspectionFailures");
                });

            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionFailureHistory", b =>
                {
                    b.Property<int>("BuildStationInspectionFailureHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildStationInspectionFailureHistoryId"), 1L, 1);

                    b.Property<int>("BuildStationInspectionHistoryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BuildStationInspectionFailureHistoryId");

                    b.HasIndex("BuildStationInspectionHistoryId");

                    b.HasIndex("FailureTypeId");

                    b.ToTable("BuildStationInspectionFailureHistories");
                });

            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionHistory", b =>
                {
                    b.Property<int>("BuildStationInspectionHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildStationInspectionHistoryId"), 1L, 1);
                    ...
                    b.HasKey("BuildStationInspectionHistoryId");
                    ...
                    b.ToTable("BuildStationInspectionHistories");
                });
            ...
            modelBuilder.Entity("QBD2.Entities.BuildTemplateStation", b =>
                {
                    b.Property<int>("BuildTemplateStationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildTemplateStationId"), 1L, 1);
                    ...
                    b.HasKey("BuildTemplateStationId");

                    b.HasIndex("BuildStationId");

                    b.HasIndex("BuildTemplateId");

                    b.ToTable("BuildTemplateStations");
                });
            ...
            modelBuilder.Entity("QBD2.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3dd07273-c874-48b8-b81e-e97bc2edcfd8",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "a2e9488a-fb52-4c20-b579-d706ffe0c7e8",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bb6f035b-3eb6-4a9a-99e9-fae6d36baf56",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5f89fca1-3144-4096-8e67-c60ea3976928",
                            Name = "CanDeleteRepair",
                            NormalizedName = "CANDELETEREPAIR"
                        },
                        new
                        {
                            Id = "cb600ffc-0a68-4c35-8bbf-0ee56df3c139",
                            ConcurrencyStamp = "7a39503d-adf8-4f70-96cc-719ab64a358c",
                            Name = "WorkOrderAdmin",
                            NormalizedName = "WORKORDERADMIN"
                        });
                });
            ...
            modelBuilder.Entity("QBD2.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "44b440ed-7710-40a4-909d-b24af60562f7",
                            ...
                            SecurityStamp = "4c1d0f64-c8a0-443e-9e2d-986286cc45ef",
            ...
            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionFailure", b =>
                {
                    b.HasOne("QBD2.Entities.BuildStationInspection", "BuildStationInspection")
                        .WithMany("BuildStationInspectionFailures")
                        .HasForeignKey("BuildStationInspectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BuildStationInspection");
            ...
            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionFailureHistory", b =>
                {
                    b.HasOne("QBD2.Entities.BuildStationInspectionHistory", "BuildStationInspectionHistory")
                        .WithMany()
                        .HasForeignKey("BuildStationInspectionHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BuildStationInspectionHistory");
            ...
            modelBuilder.Entity("QBD2.Entities.BuildStationInspectionHistory", b =>
                {
                    ...
                    b.HasOne("QBD2.Entities.WorkOrder", "WorkOrder")
                        .WithMany("BuildStationInspectionHistories")
                        .HasForeignKey("WorkOrderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("QBD2.Entities.BuildStationInspection", b =>
                {
                    b.Navigation("BuildStationInspectionFailures");
                });
            ...
            modelBuilder.Entity("QBD2.Entities.WorkOrder", b =>
                {
                    b.Navigation("BuildStationInspectionHistories");
